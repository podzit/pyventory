from packages.env import this_folder, text, DB, BACKUP_DAYS
from packages.sql_functions import dump
import os, datetime, logging

today = (datetime.datetime.today()).strftime('%d-%m-%Y')
old = ((datetime.datetime.today())-datetime.timedelta(days=BACKUP_DAYS)).strftime('%d-%m-%Y')
...
if os.path.exists(old_db_file):
    ...
    logging.warning(f"{text['old_backup_removed']} {old_db_file}")